...
function loadSection4() {
  ...
  if (mq.matches) {
    tabImgSrc1 = "video/Mango.mp4";
    tabImgSrc2 = "video/Fruit.mp4";
    tabImgSrc3 = "video/Swamp Monster.mp4";
    tabImgSrc4 = "video/Tiki Block.mp4";
    tabImgSrc5 = "video/Frog.mp4";
    tabImgSrc6 = "video/Barrel.mp4";
    tabImgSrc7 = "video/Bamboo Cage.mp4";
  } 
...
<<<<<<< HEAD
  ...
  let tabImgSrc2 = "images/WaterRing.gif";
  let tabImgSrc3 = "images/Crossfire.gif";
  let tabImgSrc4 = "images/Tornado.gif";
  let tabImgSrc5 = "images/SuperRing.gif";
  let tabImgSrc6 = "images/Combined.gif";
  let tabImgSrc7 = "images/BoardCleaner.gif";
  
  if (mq.matches) {
    tabImgSrc1 = "video/Fire Ball.mp4";
    tabImgSrc2 = "video/Water Ring.mp4";
    tabImgSrc3 = "video/Tornado.mp4";
    tabImgSrc4 = "video/Cross Fire.mp4";
    tabImgSrc5 = "video/Super Water Ring.mp4";
    tabImgSrc6 = "video/Line Explosion.mp4";
    tabImgSrc7 = "video/Board Cleaner.mp4";
  } 
